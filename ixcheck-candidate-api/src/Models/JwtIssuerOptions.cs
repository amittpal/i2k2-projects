...
namespace IXCheckCandidateApi.Models
{
    public class JwtIssuerOptions : IJwtIssuerOptions
    {
        ...
        ///   customer for clock skew.  Its value MUST be a number containing a
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 2hr)
        /// </summary>
        ...
        ///   a few minutes, to customer for clock skew.  Its value MUST be a number
