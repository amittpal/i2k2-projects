...
{
    public interface IPayUMoneyRequestDetail
    {
        ...
        [JsonProperty(PropertyName = ApplicationJsonReturnConstants.PropertyNames.PayUMoneyResponse)]
        public PayUMoneyResponseDetail PayUMoneyResponseDetail { get; set; }
    }
}