...
import { NgxIxcheckUsernameComponent } from 'ngx-ixcheck-username-lib';
import { NgxIxcheckPhoneComponent } from 'ngx-ixcheck-phone-lib';
import { NgxIxcheckRegTypeListComponent } from 'ngx-ixcheck-regtype-list-lib';
import { NgxIxcheckPhotouploaderAiComponent } from 'ngx-ixcheck-photouploader-ai-lib';

import { NgxIxcheckConfirmEmailComponent } from 'ngx-ixcheck-confirm-email-lib';
import { NgxIxcheckConfirmMobilenumberComponent } from 'ngx-ixcheck-confirm-mobilenumber-lib';
import { NgxIxcheckCustomHtmlComponent } from 'ngx-ixcheck-custom-html-lib';
import { NgxIxcheckDateOfAttestationComponent } from 'ngx-ixcheck-date-of-attestation-lib';
import { NgxIxcheckDateOfDischargeComponent } from 'ngx-ixcheck-date-of-discharge-lib';
import { NgxIxcheckTrueFalseComponent } from 'ngx-ixcheck-truefalse-lib';
import { NgxIxcheckCertificateIssuingDateComponent } from 'ngx-ixcheck-certificate-issuing-date-lib';
import { NgxIxcheckCertificateNumberComponent } from 'ngx-ixcheck-certificate-number-lib';
import { NgxIxcheckCertificationIssuingAuthorityComponent } from 'ngx-ixcheck-certification-issuing-authority-lib';
import { NgxIxcheckCertificationIssuingDistrictComponent } from 'ngx-ixcheck-certification-issuing-district-lib';
import { NgxIxcheckEducationalDetailsComponent } from 'ngx-ixcheck-educational-details-lib';
import { NgxIxcheckPhQuestionComponent } from 'ngx-ixcheck-ph-question-lib';
import { NgxIxcheckExServicemanQuestionComponent } from 'ngx-ixcheck-exserviceman-question-lib';
import { NgxIxcheckFreedomFighterQuestionComponent } from 'ngx-ixcheck-freedom-fighter-question-lib';
import { NgxIxcheckOrphanQuestionComponent } from 'ngx-ixcheck-orphan-question-lib';
import { NgxIxcheckDomicileCheckComponent } from 'ngx-ixcheck-domicile-check-lib';
import { NgxIxcheckPlaceComponent } from 'ngx-ixcheck-place-lib';
import { NgxIxcheckCaptchaComponent } from 'ngx-ixcheck-captcha-lib';
import { NgxIxcheckDivisionalOfficersCourseComponent } from 'ngx-ixcheck-divisional-officers-course-lib';
import { NgxIxcheckDegreeInFireEngineeringComponent } from 'ngx-ixcheck-degree-in-fire-engineering-lib';
import { NgxIxcheckAutomobileRepairingQuestionComponent } from 'ngx-ixcheck-automobile-repairing-question-lib';
import { NgxIxcheckExperienceInFireFightingQuestionComponent } from 'ngx-ixcheck-experience-in-fire-fighting-question-lib';
import { NgxIxcheckServedInTerritorialArmyQuestionComponent } from 'ngx-ixcheck-served-in-territorial-army-question-lib';
import { NgxIxcheckCadetCorpsCertificateQuestionComponent } from 'ngx-ixcheck-cadet-corps-certificate-question-lib';
import { NgxIxcheckRelaxationInPhysicalStandardsQuestionComponent } from 'ngx-ixcheck-relaxation-in-physical-standards-question-lib';
import { NgxIxcheckCriminalRecordQuestionComponent } from 'ngx-ixcheck-criminal-record-question-lib';
import { NgxIxcheckBlackListedQuestionComponent } from 'ngx-ixcheck-black-listed-question-lib';
import { NgxIxcheckIdProofNumberComponent } from 'ngx-ixcheck-id-proof-number-lib';
import { NgxIxcheckCaptchaTextboxComponent } from 'ngx-ixcheck-captcha-textbox-lib';
import { NgxIxcheckIpAddressComponent } from 'ngx-ixcheck-ipaddress-lib';
...
const components = {
  ...
  NgxIxcheckUsername:NgxIxcheckUsernameComponent,
  NgxIxcheckPhone:NgxIxcheckPhoneComponent,
  NgxIxcheckRegTypeList:NgxIxcheckRegTypeListComponent,
  NgxIxcheckPhotouploaderAi:NgxIxcheckPhotouploaderAiComponent,
  NgxIxcheckConfirmEmail:NgxIxcheckConfirmEmailComponent,
  NgxIxcheckConfirmMobilenumber:NgxIxcheckConfirmMobilenumberComponent,
  NgxIxcheckCustomHtml:NgxIxcheckCustomHtmlComponent,
  NgxIxcheckDateOfAttestation:NgxIxcheckDateOfAttestationComponent,
  NgxIxcheckDateOfDischarge:NgxIxcheckDateOfDischargeComponent,
  NgxIxcheckTrueFalse:NgxIxcheckTrueFalseComponent,
  NgxIxcheckCertificateIssuingDate:NgxIxcheckCertificateIssuingDateComponent,
  NgxIxcheckCertificateNumber:NgxIxcheckCertificateNumberComponent,
  NgxIxcheckCertificationIssuingAuthority:NgxIxcheckCertificationIssuingAuthorityComponent,
  NgxIxcheckCertificationIssuingDistrict:NgxIxcheckCertificationIssuingDistrictComponent,
  NgxIxcheckEducationalDetails: NgxIxcheckEducationalDetailsComponent,
  NgxIxcheckPhQuestion:NgxIxcheckPhQuestionComponent,
  NgxIxcheckExServicemanQuestion:NgxIxcheckExServicemanQuestionComponent,
  NgxIxcheckFreedomFighterQuestion:NgxIxcheckFreedomFighterQuestionComponent,
  NgxIxcheckOrphanQuestion:NgxIxcheckOrphanQuestionComponent,
  NgxIxcheckDomicileCheck:NgxIxcheckDomicileCheckComponent,
  NgxIxcheckPlace:NgxIxcheckPlaceComponent,
  NgxIxcheckCaptcha:NgxIxcheckCaptchaComponent,
  NgxIxcheckDivisionalOfficersCourse:NgxIxcheckDivisionalOfficersCourseComponent,
  NgxIxcheckDegreeInFireEngineering:NgxIxcheckDegreeInFireEngineeringComponent,
  NgxIxcheckAutomobileRepairingQuestion:NgxIxcheckAutomobileRepairingQuestionComponent,
  NgxIxcheckExperienceInFireFightingQuestion:NgxIxcheckExperienceInFireFightingQuestionComponent,
  NgxIxcheckServedInTerritorialArmyQuestion:NgxIxcheckServedInTerritorialArmyQuestionComponent,
  NgxIxcheckCadetCorpsCertificateQuestion:NgxIxcheckCadetCorpsCertificateQuestionComponent,
  NgxIxcheckRelaxationInPhysicalStandardsQuestion:NgxIxcheckRelaxationInPhysicalStandardsQuestionComponent,
  NgxIxcheckCriminalRecordQuestion:NgxIxcheckCriminalRecordQuestionComponent,
  NgxIxcheckBlackListedQuestion:NgxIxcheckBlackListedQuestionComponent,
  NgxIxcheckIdProofNumber:NgxIxcheckIdProofNumberComponent,
  NgxIxcheckCaptchaTextbox:NgxIxcheckCaptchaTextboxComponent,
  NgxIxcheckIpAddress:NgxIxcheckIpAddressComponent
...
export class LoadComponentDirective implements OnChanges {  
  ...
  componentsWithOutput=
  [
    "NgxIxcheckNextbutton",
    "NgxIxcheckBackbutton",
    "NgxIxcheckFileuploader",
    "NgxIxcheckPhotouploader",
    "NgxIxcheckPhotouploaderAi",
    "NgxIxcheckSignatureUploader",
    "NgxIxcheckRegTypeList"
  ...
  ngOnChanges(): void {        
   ...
   if (component) {
    ...
    //if additional details object has any value
    if(this.additionalDetails)
    {
      this.component.instance.additionalDetails=this.additionalDetails;
    }
