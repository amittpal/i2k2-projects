...
@Component({
  selector: 'app-layout-preview-filter',
  templateUrl: './layout-preview-filter.component.html',
  styleUrls: ['./layout-preview-filter.component.scss']
})
export class LayoutPreviewFilterComponent implements OnInit {
  ...
  ngOnInit() {    
    let filters = this.filterService.getFilter("layoutsPreviewFilter");
    if (filters === undefined) {
      this.filterService.addFilter("layout");
      filters = this.filterService.getFilter("layoutsPreviewFilter");
    }
    this.initFormGroup();
  ...
  public initFormGroup() {
    ...
    let savedfilter = this.filterService.getFilter("layoutsPreviewFilter");
  ...
  public updateFilterService() {
    let filters = this.filterService.getFilter("layoutsPreviewFilter");
    if (filters) {
      this.filterService.updateFilter(this.searchFilter.layout, 0, "layoutsPreviewFilter");
    }
  }
