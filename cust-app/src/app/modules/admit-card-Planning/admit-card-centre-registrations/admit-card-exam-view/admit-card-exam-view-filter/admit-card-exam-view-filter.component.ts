...
@Component({
  selector: 'app-admit-card-exam-view-filter',
  templateUrl: './admit-card-exam-view-filter.component.html',
  styleUrls: ['./admit-card-exam-view-filter.component.scss']
})
export class AdmitCardExamViewFilterComponent implements OnInit {
