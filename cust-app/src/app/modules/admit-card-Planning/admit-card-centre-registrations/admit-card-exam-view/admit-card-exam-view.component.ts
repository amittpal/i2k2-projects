...
@Component({
  selector: 'app-admit-card-exam-view',
  templateUrl: './admit-card-exam-view.component.html',
  styleUrls: ['./admit-card-exam-view.component.scss']
})
export class AdmitCardExamViewComponent implements OnInit {
  ...
  ngOnInit() {
        //setting page title
        this.primaryHeader.pageTitle.next("Exam List");
