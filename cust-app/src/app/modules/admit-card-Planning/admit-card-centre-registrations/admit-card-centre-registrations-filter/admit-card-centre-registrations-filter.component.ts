...
@Component({
  selector: 'app-admit-card-centre-registrations-filter',
  templateUrl: './admit-card-centre-registrations-filter.component.html',
  styleUrls: ['./admit-card-centre-registrations-filter.component.scss']
})
export class AdmitCardCentreRegistrationsFilterComponent implements OnInit {
