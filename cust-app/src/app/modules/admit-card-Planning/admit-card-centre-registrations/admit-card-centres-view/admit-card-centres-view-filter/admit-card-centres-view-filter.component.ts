...
@Component({
  selector: 'app-admit-card-centres-view-filter',
  templateUrl: './admit-card-centres-view-filter.component.html',
  styleUrls: ['./admit-card-centres-view-filter.component.scss']
})
export class AdmitCardCentresViewFilterComponent implements OnInit {
