...
@Component({
  selector: 'app-admit-card-registrations',
  templateUrl: './admit-card-registrations.component.html',
  styleUrls: ['./admit-card-registrations.component.scss']
})
export class AdmitCardRegistrationsComponent implements OnInit {
  public items = [];
  public itemCount = 0;
