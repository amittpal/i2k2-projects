...
@Component({
  selector: 'app-publish-exam-list',
  templateUrl: './publish-exam-list.component.html',
  styleUrls: ['./publish-exam-list.component.scss']
})
export class PublishExamListComponent implements OnInit {
  public items = [];
  public itemCount = 0;
  ...
  ngOnInit() {
    //setting page title
    this.primaryHeader.pageTitle.next("PUBLISH ADMIT CARDS");
  }
