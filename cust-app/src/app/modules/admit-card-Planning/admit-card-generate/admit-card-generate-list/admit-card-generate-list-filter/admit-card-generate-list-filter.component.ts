...
@Component({
  selector: 'app-admit-card-generate-list-filter',
  templateUrl: './admit-card-generate-list-filter.component.html',
  styleUrls: ['./admit-card-generate-list-filter.component.scss']
})
export class AdmitCardGenerateListFilterComponent implements OnInit {
