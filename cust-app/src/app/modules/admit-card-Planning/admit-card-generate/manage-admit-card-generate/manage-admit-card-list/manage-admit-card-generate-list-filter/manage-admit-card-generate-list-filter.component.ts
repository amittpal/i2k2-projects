...
@Component({
  selector: 'app-manage-admit-card-generate-list-filter',
  templateUrl: './manage-admit-card-generate-list-filter.component.html',
  styleUrls: ['./manage-admit-card-generate-list-filter.component.scss']
})
export class ManageAdmitCardGenerateListFilterComponent implements OnInit {
