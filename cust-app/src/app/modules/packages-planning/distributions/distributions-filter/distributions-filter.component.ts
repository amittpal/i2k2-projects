...
@Component({
  selector: 'app-distributions-filter',
  templateUrl: './distributions-filter.component.html',
  styleUrls: ['./distributions-filter.component.scss']
})
export class DistributionsFilterComponent implements OnInit {
