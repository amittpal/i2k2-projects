...
@Component({
  selector: 'app-question-requirements-filter',
  templateUrl: './question-requirements-filter.component.html',
  styleUrls: ['./question-requirements-filter.component.scss']
})
export class QuestionRequirementsFilterComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   getExamData() {
    // Get Exam Type List
    this.restService.ApiEndPointUrlOrKey = QuestionRequirement.getExamTypeList;
    ...
    // Get Language List
    this.restService.ApiEndPointUrlOrKey = QuestionRequirement.getLanguageList;
    this.restService.ApiEndPointMehod = RestMethods.Get;
    this.restService.callApi().subscribe(successResponse => {
    ...
    // Get Subject List
    this.restService.ApiEndPointUrlOrKey = QuestionRequirement.getSubjectList;
    this.restService.ApiEndPointMehod = RestMethods.Get;
    this.restService.callApi().subscribe(successResponse => {
    ...
    this.restService.ApiEndPointUrlOrKey = QuestionRequirement.getPlanStatusList;
    this.restService.ApiEndPointMehod = RestMethods.Get;
    this.restService.callApi().subscribe(successResponse => {
