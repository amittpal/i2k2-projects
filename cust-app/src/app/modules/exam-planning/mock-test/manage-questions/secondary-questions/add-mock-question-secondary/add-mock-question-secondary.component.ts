...
@Component({
  selector: 'app-add-mock-question-secondary',
  templateUrl: './add-mock-question-secondary.component.html',
  styleUrls: ['./add-mock-question-secondary.component.scss']
})
export class AddMockQuestionSecondaryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.primaryHeader.pageTitle.next("MOCK QUESTIONS ADD");
  ...
  getQuestionDetails() {    
    ...
    this.restService.ApiEndPointUrlOrKey = Exam.getMockTestSecondaryQuestionsDetailsById;
  ...
  onQuestionNumberSelect(questionDetails: any) {
    // //selecting default tab before navigation
    // this.tabset.tabs[0].active = true;
    // //clearing existing values optionsArray.
    // (<FormArray>this.questionAddFormGroup.get('optionsArray')).clear();
