...
@Component({
  selector: 'app-mock-question-filter',
  templateUrl: './mock-question-filter.component.html',
  styleUrls: ['./mock-question-filter.component.scss']
})
export class MockQuestionFilterComponent implements OnInit {
  ...
  ngOnInit() {
    //console.log(this.MockQuestionId);
