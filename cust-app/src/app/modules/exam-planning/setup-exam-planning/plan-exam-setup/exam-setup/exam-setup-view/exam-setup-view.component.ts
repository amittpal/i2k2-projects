...
@Component({
  selector: 'app-view-exam-setup',
  templateUrl: './exam-setup-view.component.html',
  styleUrls: ['./exam-setup-view.component.scss']
})
export class ExamSetupViewComponent implements OnInit {
