...
@Component({
  selector: 'app-imported-centres-view-details',
  templateUrl: './imported-centres-view-details.component.html',
  styleUrls: ['./imported-centres-view-details.component.scss']
})
export class ImportedCentresViewDetailsComponent implements OnInit {
