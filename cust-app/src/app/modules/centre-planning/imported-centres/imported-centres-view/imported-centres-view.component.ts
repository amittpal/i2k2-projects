...
@Component({
  selector: 'app-imported-centres-view',
  templateUrl: './imported-centres-view.component.html',
  styleUrls: ['./imported-centres-view.component.scss']
})
export class ImportedCentresViewComponent implements OnInit {

  public viewImportedCentredFormGroup:FormGroup;
  ...
  ngOnInit() {
    ...
    this.viewImportedCentredFormGroup = new FormGroup({
