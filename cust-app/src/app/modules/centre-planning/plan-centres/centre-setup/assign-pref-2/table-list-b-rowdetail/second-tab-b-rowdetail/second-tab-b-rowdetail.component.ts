...
@Component({
  selector: "app-second-tab-b-rowdetail",
  templateUrl: "./second-tab-b-rowdetail.component.html",
  styleUrls: ["./second-tab-b-rowdetail.component.scss"],
})
export class SecondTabBRowdetailComponent implements OnInit {
