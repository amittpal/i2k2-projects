...
@Component({
  selector: 'app-first-tab-b-rowdetail',
  templateUrl: './first-tab-b-rowdetail.component.html',
  styleUrls: ['./first-tab-b-rowdetail.component.scss']
})
export class FirstTabBRowdetailComponent implements OnInit {
