...
@Component({
  selector: "app-first-tab-c-rowdetail",
  templateUrl: "./first-tab-c-rowdetail.component.html",
  styleUrls: ["./first-tab-c-rowdetail.component.scss"],
})
export class FirstTabCRowdetailComponent implements OnInit {
  ...
  getCentresList() {
    ...
    this.restService.ApiEndPointUrlOrKey = Centre.getAssignPrefCentreListC;
