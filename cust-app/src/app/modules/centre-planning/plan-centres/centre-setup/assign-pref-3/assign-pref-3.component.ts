...
@Component({
  selector: 'app-assign-pref-3',
  templateUrl: './assign-pref-3.component.html',
  styleUrls: ['./assign-pref-3.component.scss']
})
export class AssignPrefCComponent implements OnInit {
  @Input() examGuid: any;
