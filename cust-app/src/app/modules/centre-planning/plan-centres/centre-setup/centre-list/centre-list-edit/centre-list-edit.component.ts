...
@Component({
  selector: 'app-centre-list-edit',
  templateUrl: './centre-list-edit.component.html',
  styleUrls: ['./centre-list-edit.component.scss']
})
export class CentreListEditComponent implements OnInit {
        ...
        if (this.items.length === 0) {
          ...
          try {
            this.items.forEach((data) => {
              ...
              this.centreCapacityParam.shift_number = this.shiftNumber;
          ...
          let examGuidArray = [];
          examParam.exam_guid = this.examCode;
          ...
          if (Object.keys(this.appRoutes).length !== 0) {
            this.restService.ApiEndPointUrlOrKey = Centre.editCentres;
  ...
  getCentreList() {
    ...
    this.restService.ApiEndPointUrlOrKey = Centre.getAddedCentreListBySnapShotId;
    this.restService.ApiEndPointMehod = RestMethods.Get;
    this.restService.callApi(keyData).subscribe(
      successResponse => {
        this.items = successResponse.distributions_algo;
      })
  }
