...
@Component({
  selector: "app-table-list-b-rowdetail-view",
  templateUrl: "./table-list-b-rowdetail-view.component.html",
  styleUrls: ["./table-list-b-rowdetail-view.component.scss"]
})
export class TableListBRowdetailViewComponent implements OnInit {
  ...
  getChildComponentData(childData: any) {
    ...
    this.restService.ApiEndPointUrlOrKey = Centre.updateAddCentreDataB;
  ...
  getCentresList() {
    ...
    this.restService.ApiEndPointUrlOrKey = Centre.getAddedCentreListB;
  ...
  sendToParent() {
    this.restService.ApiEndPointUrlOrKey = Centre.updateSelectedCentreListB;
    this.restService.ApiEndPointMehod = RestMethods.Post;
