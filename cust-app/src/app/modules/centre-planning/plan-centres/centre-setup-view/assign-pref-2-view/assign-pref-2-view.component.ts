...
@Component({
  selector: 'app-assign-pref-2-view',
  templateUrl: './assign-pref-2-view.component.html',
  styleUrls: ['./assign-pref-2-view.component.scss']
})

export class AssignPrefBViewComponent implements OnInit {
  @Input() examGuid: any;
  ...
  getIntialData() {
    ...
    this.restService.ApiEndPointUrlOrKey = Centre.getAssignPrefB;
