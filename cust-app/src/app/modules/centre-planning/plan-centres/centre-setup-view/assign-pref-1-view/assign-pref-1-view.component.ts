...
@Component({
  selector: "app-assign-pref-1-view",
  templateUrl: "./assign-pref-1-view.component.html",
  styleUrls: ["./assign-pref-1-view.component.scss"]
})
export class AssignPrefAViewComponent implements OnInit {
  @Input() examGuid: any;
