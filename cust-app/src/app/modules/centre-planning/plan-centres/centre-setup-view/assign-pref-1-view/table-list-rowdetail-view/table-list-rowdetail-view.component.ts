...
@Component({
  selector: "app-table-list-rowdetail-view",
  templateUrl: "./table-list-rowdetail-view.component.html",
  styleUrls: ["./table-list-rowdetail-view.component.scss"]
})
export class TableListRowdetailViewComponent implements OnInit {
