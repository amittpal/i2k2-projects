...
@Component({
  selector: 'app-table-list-c-rowdetail',
  templateUrl: './table-list-c-rowdetail.component.html',
  styleUrls: ['./table-list-c-rowdetail.component.scss']
})
export class TableListCRowdetailComponent implements OnInit {
