...
@Component({
  selector: "app-second-tab-c-rowdetail",
  templateUrl: "./second-tab-c-rowdetail.component.html",
  styleUrls: ["./second-tab-c-rowdetail.component.scss"],
})
export class SecondTabCRowdetailComponent implements OnInit {
  ...
  setIntialdata() {
    this.childFromGroup.setValue({
      ...
      // total_seats: this.rowItemData['total_seats'] || '',
    });
