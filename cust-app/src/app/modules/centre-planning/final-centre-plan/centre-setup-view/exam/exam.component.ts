...
export class ExamComponent implements OnInit {
  ...
  public createForm() {
    this.examDetailFormGroup = new FormGroup({
      exam_days: new FormControl({ value: '', disabled: true }, Validators.required),
      snapshotCode: new FormControl({ value: '', disabled: true }, Validators.required),
      snapshotName: new FormControl({ value: '', disabled: true }, Validators.required)
    });
  }
