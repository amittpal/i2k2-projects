...
@Component({
  selector: 'app-assign-pref-2',
  templateUrl: './assign-pref-2.component.html',
  styleUrls: ['./assign-pref-2.component.scss']
})

export class AssignPrefBComponent implements OnInit {  
