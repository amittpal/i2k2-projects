...
@Component({
  selector: "app-table-list-b-rowdetail",
  templateUrl: "./table-list-b-rowdetail.component.html",
  styleUrls: ["./table-list-b-rowdetail.component.scss"]
})
export class TableListBRowdetailComponent implements OnInit {
