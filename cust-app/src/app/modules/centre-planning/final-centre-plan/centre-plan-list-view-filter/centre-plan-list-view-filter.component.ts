...
@Component({
  selector: 'app-centre-plan-list-view-filter',
  templateUrl: './centre-plan-list-view-filter.component.html',
  styleUrls: ['./centre-plan-list-view-filter.component.scss']
})
export class CentrePlanListViewFilterComponent implements OnInit {
