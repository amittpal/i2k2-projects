...
@Component({
  selector: 'app-map-centres-details',
  templateUrl: './map-centres-details.component.html',
  styleUrls: ['./map-centres-details.component.scss']
})
export class MapCentresDetailsComponent implements OnInit {
