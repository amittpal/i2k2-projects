...
@NgModule({
  declarations: [RegistrationEditComponent,BasicSetupComponent, BasicSetupRowDetailsComponent, RegTypesComponent, RegTypesRowEditComponent,
     RegTypeMappingComponent, RegTypeMappingRowEditComponent,
      RegMailServerConfigComponent, RegApplicableFeesComponent,ApplicableFeesRowDetailsComponent,
       RegApplicableFeesListComponent, RegFinalReviewComponent,
       RegistrationExamCitiesComponent,ExamCitiesRowEditComponent],
  imports: [
    CommonModule,
