...
export class MultipleChoiceManageComponent implements OnInit {
  ...
  addParams() {
    ...
    //adding answers for secondary question based on primary question answers
    this.QuestionDetails.answer = [];
    this.QuestionDetails.option_primary.forEach((value, index) => {
      if (value.selected === true) {
        ...
        this.QuestionDetails.answer.push(ansObject);
      }
    })
