...
@Component({
  selector: 'app-single-choice-review',
  templateUrl: './single-choice-review.component.html',
  styleUrls: ['./single-choice-review.component.scss']
})
export class SingleChoiceReviewComponent implements OnInit {
