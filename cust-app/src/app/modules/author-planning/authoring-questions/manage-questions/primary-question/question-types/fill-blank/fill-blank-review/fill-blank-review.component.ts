...
@Component({
  selector: 'app-fill-blank-review',
  templateUrl: './fill-blank-review.component.html',
  styleUrls: ['./fill-blank-review.component.scss']
})
export class FillBlankReviewComponent implements OnInit {
