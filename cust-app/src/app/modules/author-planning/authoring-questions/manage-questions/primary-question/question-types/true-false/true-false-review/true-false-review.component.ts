...
@Component({
  selector: 'app-true-false-review',
  templateUrl: './true-false-review.component.html',
  styleUrls: ['./true-false-review.component.scss']
})
export class TrueFalseReviewComponent implements OnInit {
