...
@Component({
  selector: 'app-true-false-approve',
  templateUrl: './true-false-approve.component.html',
  styleUrls: ['./true-false-approve.component.scss']
})
export class TrueFalseApproveComponent implements OnInit {
