...
@Component({
  selector: 'app-true-false-manage',
  templateUrl: './true-false-manage.component.html',
  styleUrls: ['./true-false-manage.component.scss']
})
export class TrueFalseManageComponent implements OnInit {
  ...
  setupInitialDetails() {       
    ...
    this.QuestionDetails.question_references = this.QuestionDetails.question_references
                                                   .map((e, index) => ({ "line_num": index + 1, ...e }));
    this.initializeForm();
  }
