...
@Component({
  selector: 'app-match-approve',
  templateUrl: './match-approve.component.html',
  styleUrls: ['./match-approve.component.scss']
})
export class MatchApproveComponent implements OnInit {
