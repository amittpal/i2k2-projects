...
@Component({
  selector: 'app-single-choice-approve',
  templateUrl: './single-choice-approve.component.html',
  styleUrls: ['./single-choice-approve.component.scss']
})
export class SingleChoiceApproveComponent implements OnInit {
  ...
  initializeForm() {
    ...
    if (examDetails) {
      this.questionApproveFormGroup = new FormGroup({
        ...
        exam_grade: new FormControl({ value: examDetails.exam_grade, disabled: true }),
        difficulty_level: new FormControl({ value: examDetails.difficulty_level, disabled: true }),
        exam_type: new FormControl({ value: examDetails.exam_type, disabled: true }),
        subject: new FormControl({ value: examDetails.subject, disabled: true }),
        question_type: new FormControl({ value: examDetails.question_type, disabled: true }),
        exam_code: new FormControl({ value: examDetails.code, disabled: true }),
