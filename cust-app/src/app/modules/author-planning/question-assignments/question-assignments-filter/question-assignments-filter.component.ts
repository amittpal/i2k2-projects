...
@Component({
  selector: 'app-question-assignments-filter',
  templateUrl: './question-assignments-filter.component.html',
  styleUrls: ['./question-assignments-filter.component.scss']
})
export class QuestionAssignmentsFilterComponent implements OnInit {
  ...
  getExamData() {  
    ...
    // // Get Subject List
    // this.restService.ApiEndPointUrlOrKey = Author.getSubjectList;
    // this.restService.callApi().subscribe(successResponse => {
